<template>
    <div class="modal fade" id="update-user-modal" tabindex="-1" data-backdrop="static" role="dialog" data-keyboard="false">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><i class="glyph-icon icon-save"></i> Update User</h4>
                </div>
                <div class="modal-body row">
                    ...
                    <div class="content-box-wrapper pad0T pad0B">
                        <button
                            :disabled="alert.notif || alert.success"
                            v-on:click="clickAttach('userUpdateFiles')"
                        ...
                        <input 
                            ...
                            ref="userUpdateFiles"
                            style="display: none" 
                            v-on:change="attachFiles($refs.userUpdateFiles.files)"/>
                    </div>
                    <div class="content-box-wrapper pad0T pad0B">
