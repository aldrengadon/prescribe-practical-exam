...
"use strict";
/*!*******************************************************!*\
  !*** ./resources/assets/modules/password/password.js ***!
  \*******************************************************/
__webpack_require__.r(__webpack_exports__);
...
vue__WEBPACK_IMPORTED_MODULE_0__["default"].config.productionTip = false; // Vue.config.silent = true
...
vue__WEBPACK_IMPORTED_MODULE_0__["default"].use((vue_progressbar__WEBPACK_IMPORTED_MODULE_3___default()), {
  color: 'red',
  failedColor: 'red',
  height: '8px'
});
vee_validate__WEBPACK_IMPORTED_MODULE_2__["default"].Validator.extend('verifyPassword', {
  getMessage: function getMessage(field) {
    return "The password must contain at least: 1 uppercase letter, 1 lowercase letter, 1 number, and one special character (E.g. ! @ # $ etc)";
  },
...
vue__WEBPACK_IMPORTED_MODULE_0__["default"].component('notification-fail', (__webpack_require__(/*! ../../../js/components/notification/notificationFail.vue */ "./resources/js/components/notification/notificationFail.vue")["default"]));
vue__WEBPACK_IMPORTED_MODULE_0__["default"].component('notification-success', (__webpack_require__(/*! ../../../js/components/notification/notificationSuccess.vue */ "./resources/js/components/notification/notificationSuccess.vue")["default"]));
vue__WEBPACK_IMPORTED_MODULE_0__["default"].component('notification-notice', (__webpack_require__(/*! ../../../js/components/notification/notificationNotice.vue */ "./resources/js/components/notification/notificationNotice.vue")["default"])); // custom header of axios

(axios__WEBPACK_IMPORTED_MODULE_1___default().defaults.headers["X-axios"]) = true;
var app = new vue__WEBPACK_IMPORTED_MODULE_0__["default"]({
  ...
  data: function data() {
    return {
      ...
      changePasswordValidations: ["validateOldPassword"]
    };
  },
  mounted: function mounted() {},
  methods: {
    savePassword: function savePassword() {
      ...
      this.$validator.validateAll().then(function (validate) {
        if (validate) {
          ...
          _this.alert.notif = true;
          _this.alert.success = false;
          _this.alert.fail = false;
          _this.alert.message = "Saving Password";
          axios__WEBPACK_IMPORTED_MODULE_1___default().get('save-password/' + _this.newPassword).then(function (response) {
