...
"use strict";
/*!*************************************************!*\
  !*** ./resources/assets/modules/login/login.js ***!
  \*************************************************/
__webpack_require__.r(__webpack_exports__);
...
Vue.component('notification-fail', (__webpack_require__(/*! ../../../js/components/notification/notificationFail.vue */ "./resources/js/components/notification/notificationFail.vue")["default"]));
Vue.component('notification-success', (__webpack_require__(/*! ../../../js/components/notification/notificationSuccess.vue */ "./resources/js/components/notification/notificationSuccess.vue")["default"]));
Vue.component('notification-notice', (__webpack_require__(/*! ../../../js/components/notification/notificationNotice.vue */ "./resources/js/components/notification/notificationNotice.vue")["default"]));
Vue.use(vee_validate__WEBPACK_IMPORTED_MODULE_1__["default"]);
Vue.use((vue_progressbar__WEBPACK_IMPORTED_MODULE_2___default()), {
  color: 'red',
  failedColor: 'red',
  height: '20px'
});
...
var app = new Vue({
  ...
  created: function created() {
    ...
    if (userStatus !== null) if (userStatus == "sessionExpired") this.setSessionExpiredLoginNotification();
  },
  methods: {
    setSessionExpiredLoginNotification: function setSessionExpiredLoginNotification() {
    ...
    login: function login() {
      ...
      this.$validator.validateAll('login').then(function (validate) {
        if (validate) {
          ...
          axios__WEBPACK_IMPORTED_MODULE_0___default().post('authenticate', data).then(function (response) {
